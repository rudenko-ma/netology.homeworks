...
;; ANSWER SECTION:
4.4.8.8.in-addr.arpa.   71531   IN      PTR     dns.google.

;; Query time: 103 msec
;; SERVER: 127.0.0.53#53(127.0.0.53)
;; WHEN: Ср янв 26 18:26:16 +10 2022
;; MSG SIZE  rcvd: 73
```
...
;; global options: +cmd
;; Got answer:
;; ->>HEADER<<- opcode: QUERY, status: NOERROR, id: 64659
;; flags: qr rd ra; QUERY: 1, ANSWER: 1, AUTHORITY: 0, ADDITIONAL: 1
...
;; ANSWER SECTION:
8.8.8.8.in-addr.arpa.   2101    IN      PTR     dns.google.

;; Query time: 0 msec
;; SERVER: 127.0.0.53#53(127.0.0.53)
;; WHEN: Ср янв 26 18:26:30 +10 2022
;; MSG SIZE  rcvd: 73
